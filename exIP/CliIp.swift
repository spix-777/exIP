...
/*
https://stackoverflow.com/a/53369573/3599237
*/
    ...
    if getifaddrs(&ifaddr) == 0 {
        ...
        while ptr != nil {
            ...
            if addrFamily == UInt8(AF_INET) || addrFamily == UInt8(AF_INET6) {
                if case let name: String = String(cString: (interface?.ifa_name)!), (WIFI_IF.contains(name) || KNOWN_WIRED_IFS.contains(name) || KNOWN_CELL_IFS.contains(name)) {
